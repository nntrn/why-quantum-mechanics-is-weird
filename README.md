...
Alien resolution translation
```
* Humans => electrons
* Aliens => physicists
* Cities => quantum systems
* Scans => measurements
```
...
Alien analog: 
> "A city is both asleep and awake until we scan it."  
> (Alien cannot tell whether the city's population is at home or out; the data is unresolved until measured)
...
Alien analog: 
> "Human movement is both a continuous flow and individual footsteps at the same time."  
> (Alien sees traffic flow patterns and discrete hotspots depending on scan method)
...
Alien analog: 
> "Our scan of Earth creates the actual distribution of human activity."  
> (Alien's technology 'collapses' city activity to one outcome)
...
Alien analog: 
> "A human is in every city at once until we observe."  
> (Alien infers probability spread, not actual multiplicity)
...
Alien analog:
> "A human crosses both city gates and neither, until we watch."  
> (Alien sees statistical patterns, not definite paths)
...
Alien analog:
> "Our choice to process city data changes what the city did yesterday."  
> (Analysis method affects what correlations are accessible)
...
Alien analog:
> "Cities, roads, and humans only exist when we scan them."
...
Alien analog:
> "A city's population pattern is instantly reproduced somewhere else."  
> (Alien expects teleportation; actually requires classical signal and prior coordination)
...
Alien analog:
> "How does a city's activity pattern become one actual configuration from all possibilities we model?"
> (Alien models possibilities; observes only one)
...
Alien analog:
> "City events are correlated in ways we can't explain by city-to-city communication."  
> (Alien observes that activity spikes in one city correlate instantly with another, beyond any message speed)
...
Alien analog:
> "What we learn about one city depends on which other cities we measure simultaneously."  
> (Alien's measurement of one region depends on the configuration of its survey)
...
Alien analog:
> "Why do the chances of finding humans in a city follow the square of our modeled activity amplitude?"  
> (Alien observes this pattern without deeper understanding)
...
Alien analog:
> "How does a fuzzy, unresolved city pattern become a sharp, unique city snapshot?"  
> (Alien sees models become resolved in measurement)
...
Alien analog:
> "Our simulations of city life run forwards and backwards the same way, but our scans always reveal only forward-in-time evolution"  
> (Alien's model and observation mismatch)
...
Alien analog:
> "How do our scan methods apply if the very ground beneath cities is itself probabilistic or fluctuating?"  
> (Alien lacks unified model of human activity and city landscape)
